...
public class Arrays01 {
    public static void main(String[] args) {
        ...
        // loop'un calisma sarti, ve increment/decrement kismini kendisi halleder
        //       for-each-loop "Array" lerde ve "Collection" larda kullanilir.
        //       Index kullanmaniz gerektiginde bazen "for-each-loop" caresiz kalir,
        //       mecburen diger loop'lari kullaniriz.
