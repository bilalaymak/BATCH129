...
public class StringManipulation10 {
    public static void main(String[] args) {
        ...
        //practice 6: valueOf(); boolean to String
        ...
        //practice 8: kullanılan karakter sayısı

        int aLength = a.length();
        System.out.println(aLength);

        //practice 9: ilk 4 karakteri alma

        String sub1 = a.substring(0,4);
        System.out.println(sub1);

        //practice 10: belli bir kelimeyi alma
        ...
        //practice 11: bir karakterden başlayıp Stringin sonuna kadar alma

        String sub4 = b.substring(8);
        System.out.println(sub4);

        //practice 12: bir kelimenin olup olmadığını control etme
        ...
        //practice 13: belli bir harfle başlıyor mu?

        boolean isStart = b.startsWith("Can");
        System.out.println(isStart);

        // practice 14: mesela 9. karakterden itibaren belli bir harfle başlıyor mu?
